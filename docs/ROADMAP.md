...
Current version: **1.18.3** (see `../CHANGELOG.md` for full detail on every
...
3. **Phase 44 — Internet P2P Connectivity** (primitives + Add-by-Link UI complete: 44.1 `locator.py`+storage as `1.18.0`, 44.2 `endpoint_update.py` as `1.18.1`, 44.3 `link.py`+click UI as `1.18.2`/`1.18.3`; `endpoint_update` wire-protocol integration and QR display still unwired) ← next
